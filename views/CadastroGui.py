...
class CadastroView:
    def __init__(self, root):
        ...
        self.label_telefone.place(x=100, y=200) 
        self.personalizar.configurar_small_label(self.label_telefone)

        self.entry_telefone = tk.Entry(root)
        self.entry_telefone.place(x=100, y=220, width=200)  
        self.personalizar.configurar_entry(self.entry_telefone)

        # Label e campo de senha
        self.label_senha = tk.Label(root, text="Senha")
        self.label_senha.place(x=100, y=260)  
        self.personalizar.configurar_small_label(self.label_senha)

        self.entry_senha = tk.Entry(root, show="*")
        self.entry_senha.place(x=100, y=280, width=200)  
        ...
        self.btn_cadastrar.place(x=160, y=320)
        ...
        self.label_ja_conta.place(x=90, y=380)
        self.personalizar.configurar_small_label(self.label_ja_conta, fg="white", bg="#70cfff")

        # Botão "Entre"
        self.btn_entrar = tk.Button(root, text="Entre", command=self.abrir_login_view)
        self.btn_entrar.place(x=255, y=376)
    ...
    def cadastrar_usuario(self):
        ...
        if nome and email and senha:
            sucesso = self.usuario_controller.cadastrar_usuario(nome, email, telefone, senha)
            if sucesso:
